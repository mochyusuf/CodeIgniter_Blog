                ...
                init: function (e) {
                    ...
                    return a(s).bind("submit", function (e) {
                        ...
                        var e = a(this),
                            ...
                            l = n.find(".text-danger").first(),
                            s = e.parents("form").first(),
                            d = [];
                        if (!l.length && t.options.autoAdd && t.options.autoAdd.helpBlocks && (l = a('<div class="text-danger" />'), n.find(".controls").append(l), i.push(l[0])), t.options.sniffHtml) {
                            var c = "";
