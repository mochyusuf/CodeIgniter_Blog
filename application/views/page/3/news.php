        ...
        <div class="row">
            ...
            <h5 class="card-header theme-header ">Kategori</h5>
                <ul class="list-group theme-list-group">    
                    <?php 
                    if($kategori_count > 0){?>
                        <a href="<?php echo base_url()."index.php/news?page=1&kategori=all"; ?>" class="list-group-item <?php echo ($kategori_page == "all") ? "theme-list-active" : "theme-list" ;?>">-- Semua Album --</a>
                        <?php 
