    ...
    <div class="container">
        ...
        <ul class="pagination justify-content-center theme-pagination">
			...
			?>
				<li <?php echo $link_active; ?>><a class="page-link" href="<?php echo base_url()."index.php/galeri" ?>?page=<?php echo $i; ?>&album=<?php echo ($album_page == 0) ? "all" : $album_page;; ?>"><?php echo $i; ?></a></li>
			<?php
			}
			?>
