    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-3">
                    ...
                    <?php
							//Tampilkan Album
                            if($album_count > 0){?>
                                <a href="<?php echo base_url()."page/galeri.php?page=1&album=all"; ?>" class="list-group-item <?php echo ($album_page == "all") ? "theme-list-active" : "theme-list" ;?>">-- Semua Album --</a>
                                <?php 
                                foreach($album as $row){?>
                                <a href="<?php echo base_url()."page/galeri.php?page=1&album=".$row['id_album']; ?>"  class="list-group-item <?php echo ($album_page == $row['id_album']) ? "theme-list-active" : "theme-list" ;?>"><?php echo $row['judul_album']; ?></a>
                            <?php } ?>
                            <?php 
                            } else{
								//Album = 0
                    ...
                    if($galeri_count > 0){?>
                        ...
                        <?php foreach($galeri_limit as $row){?>
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                <div class="btn-space">
                                    <img class="img-fluid view_data" src="<?php echo base_url().$row["gambar"]; ?>" data-toggle="modal" data-target="#myImage" alt="" id="<?php echo $row['id_galeri']; ?>">
                                    </br>
                                </div>
                            </div>
                    <?php } ?>
        ...
        <ul class="pagination justify-content-center theme-pagination">
			...
			?>
				<li <?php echo $link_active; ?>><a class="page-link" href="<?php echo base_url()."page/galeri.php" ?>?page=<?php echo $i; ?>&album=<?php echo ($album_page == 0) ? "all" : $album_page;; ?>"><?php echo $i; ?></a></li>
			<?php
			}
			?>
