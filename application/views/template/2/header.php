...
<html lang="en">
    ...
    <div class="jumbotron theme-jumbotron">
        <img src="<?php echo base_url();?>assets/image/logoTP.png" style="max-height: 60px;" alt="" class="img-fluid">
        <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat non, tempora incidunt ut maxime perspiciatis</h1>
    </div>
    <hr>
